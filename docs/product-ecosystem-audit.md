...
Pro tier with unlimited generations for normal use, fair-use abuse guardrails,
and premium personas. The remaining landing monetization question is whether the
new pricing-card structure and interval analytics actually improve live
conversion after the annual repricing.
...
- Pro unlocks unlimited generations for normal use, all premium personas,
  full/deep conversation memory, and priority support.
...
| Pro pricing copy    | Pro cards now disclose normal-use unlimited generations and fair-use guardrails | App copy includes normal-use unlimited generations, Deep Memory, Priority support, and fair-use abuse guardrails             | `index.html`, `components/ProPaywallCard.tsx`, `lib/appConfig.ts`, `app/(tabs)/settings.tsx`, `app/(tabs)/marketplace.tsx`, `app/chat.tsx`, `terms.html`, `privacy.html` | Monitoring | Keep landing and app disclosures aligned as paid-plan copy evolves                                              | Landing | None                                                           |
